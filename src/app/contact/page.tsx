                ...
                <div className="border border-silver/10 bg-ash/10 p-6">
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <MapPin size={16} className="flex-shrink-0 text-silver/40" />
                      <span className="text-silver/50">
                        Mosquera, Cundinamarca, Colombia
                      </span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Mail size={16} className="flex-shrink-0 text-silver/40" />
                      <a
                    ...
                    <div className="flex items-center gap-3">
                      <Phone size={16} className="flex-shrink-0 text-silver/40" />
                      <span className="text-silver/50">
